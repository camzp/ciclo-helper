...
class _MyBikeEditFormState extends State<MyBikeEditForm>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: isShowing ? FloatingActionButton(
          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => MyBikeEditForm(isEditable: true, isShowing: false, myBike: widget.myBike, onSave:
              (myBike){
            myBike.id = myBike.id;
